...
namespace Chat.client {
    ...
    public class Client
    {
        ...
        public void Connect()
        {
            ...
            while(!client.Connected &&  localAppTime.Elapsed.Milliseconds - connectionStartTime > 10000)
            {
                client.BeginConnect(ipe, new AsyncCallback(ConnectCallback), localState);
            }




            while (!downloadAcknowledge)
            {
                sendThread.Reset();
